import { NotificationComponent } from './components/notification-external/notification-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, NotificationComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, NotificationComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
