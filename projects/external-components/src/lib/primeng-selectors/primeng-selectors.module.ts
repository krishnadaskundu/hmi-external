import { DashboardComponent } from './components/dashboard-external/dashboard-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, DashboardComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, DashboardComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
