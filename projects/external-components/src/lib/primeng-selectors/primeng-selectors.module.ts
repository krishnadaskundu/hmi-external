import { TodoooosComponent } from './components/todoooos-external/todoooos-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TodoooosComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TodoooosComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
