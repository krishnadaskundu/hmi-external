import { Test1000Component } from './components/test1000-external/test1000-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, Test1000Component],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, Test1000Component],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
