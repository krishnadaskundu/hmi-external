import { LoginComponent } from './components/login-external/login-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, LoginComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, LoginComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
