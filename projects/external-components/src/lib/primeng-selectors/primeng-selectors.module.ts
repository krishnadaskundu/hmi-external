import { DoctorsClinicComponent } from './components/DoctorsClinic-external/DoctorsClinic-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, DoctorsClinicComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, DoctorsClinicComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
